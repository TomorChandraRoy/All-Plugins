...
const ModernSlider = ({
  ...
  }, modernSlides?.map((_, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
    key: index,
    type: "button",
  ...
  }, modernSlides?.map((slide, index) => (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("div", {
    key: index,
  ...
  }, (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("h5", null, slide.title || `Slide ${index + 1}`), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("p", null, slide.description || "Your description here."))))), (0,react__WEBPACK_IMPORTED_MODULE_0__.createElement)("button", {
